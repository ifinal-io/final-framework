...
public class FinalXmlMapperBuilder implements XmlMapperBuilder {
    ...
    private void init() {
        ...
        sqlFragmentXmlMapperBuilders.add(new SqlOnDuplicateKeyFragmentXmlMapperBuilder(typeHandlers));
        ...
        sqlFragmentXmlMapperBuilders.add(new SqlCriterionValueFragmentXmlMapperBuilder(typeHandlers, 0));

package cn.com.likly.finalframework.coding.plugins.domain;
                    ...
                    it.stream()
                            .forEach(property -> {
                                if (property.hasAnnotation(MultiColumn.class)) {
                                    ...
                                    cn.com.likly.finalframework.coding.element.Entity<Property> multiEntity = EntityFactory.create(processingEnv, multiElement);

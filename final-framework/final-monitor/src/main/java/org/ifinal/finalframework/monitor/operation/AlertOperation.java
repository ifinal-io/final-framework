...
import org.ifinal.finalframework.monitor.handler.AlertOperationHandler;
...
public class AlertOperation implements Operation {
    ...
    public static class Builder implements org.ifinal.finalframework.util.Builder<AlertOperation> {

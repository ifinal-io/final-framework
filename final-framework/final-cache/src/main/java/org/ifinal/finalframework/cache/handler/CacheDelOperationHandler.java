...
public class CacheDelOperationHandler extends AbsCacheOperationHandlerSupport implements OperationHandler<Cache, CacheDel> {
    ...
    @Override
    public Void before(@NonNull Cache cache, @NonNull OperationContext context) {
    ...
    @Override
    public void afterReturning(@NonNull Cache cache, @NonNull OperationContext context, Object result) {
    ...
    @Override
    public void afterThrowing(@NonNull Cache cache, @NonNull OperationContext context, @NonNull Throwable throwable) {
    ...
    @Override
    public void after(@NonNull Cache cache, @NonNull OperationContext context, Object result, Throwable throwable) {
        if (CutPoint.AFTER != context.cutPoint()) {
            invocation(cache, context, result, throwable);
        }
    }

    private void invocation(@NonNull Cache cache, @NonNull OperationContext context, Object result, Throwable throwable) {

...
(function (e) {
    ...
    e(function () {
        ...
        e("figure.highlight, div.highlight").each(function () {
            var t = '<div class="bd-clipboard"><button class="btn-clipboard" title="复制到剪贴板">复制</button></div>';
            e(this).before(t);
        ...
        t.on("success", function (t) {
            e(t.trigger).attr("title", "Copied!").tooltip("_fixTitle").tooltip("show").attr("title", "复制到剪贴板").tooltip("_fixTitle");
            t.clearSelection()
        });
        t.on("error", function (t) {
            var n = /Mac/i.test(navigator.userAgent) ? "⌘" : "Ctrl-";
            var r = "Press " + n + "C to copy";
            e(t.trigger).attr("title", r).tooltip("_fixTitle").tooltip("show").attr("title", "复制到剪贴板").tooltip("_fixTitle")
        });
            ...
            window.docsearch({
                ...
                transformData: function (e) {
                    return e.map(function (e) {
                        e.url = e.url.replace("https://v4.bootcss.com", "/docs/4.0");
                        return e
                    })
                },
                debug: false

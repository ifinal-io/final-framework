...
(function () {
  ...
  AbstractChosen = (function () {
    ...
    AbstractChosen.prototype.set_default_values = function () {
      ...
      this.is_rtl = this.options.rtl || /\bchosen-rtl\b/.test(
    ...
    AbstractChosen.prototype.result_add_group = function (group) {
      ...
      group_el.innerHTML = group.highlighted_html || this.escape_html(
          group.label);
      if (group.title) {
            ...
            if (option.search_match) {
              if (query.length) {
                ...
                option.highlighted_html = (this.escape_html(prefix)) + "<em>"
                    + (this.escape_html(fix)) + "</em>" + (this.escape_html(
                        suffix));
              }
    ...
    AbstractChosen.prototype.get_single_html = function () {
      return "<a class=\"chosen-single chosen-default\">\n  <span>"
          + this.default_text
          + "</span>\n  <div><b></b></div>\n</a>\n<div class=\"chosen-drop card\">\n  <div class=\"chosen-search form-group\">\n    <input class=\"chosen-search-input from-control\" type=\"text\" autocomplete=\"off\" />\n  </div>\n  <ul class=\"chosen-results\"></ul>\n</div>";
    };
    ...
    AbstractChosen.browser_is_supported = function () {
      ...
      if (/iP(od|hone)/i.test(window.navigator.userAgent) || /IEMobile/i.test(
          window.navigator.userAgent) || /Windows Phone/i.test(
          window.navigator.userAgent) || /BlackBerry/i.test(
          window.navigator.userAgent) || /BB10/i.test(
          window.navigator.userAgent) || /Android.*Mobile/i.test(
  ...
  Chosen = (function (superClass) {
    ...
    Chosen.prototype.search_field_disabled = function () {
      this.is_disabled = this.form_field.disabled || this.form_field_jq.parents(
    ...
    Chosen.prototype.search_results_mouseout = function (evt) {
      if ($(evt.target).hasClass("active-result") || $(evt.target).parents(
          '.active-result').first()) {

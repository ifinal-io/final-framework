...
(function (mod) {
  ...
  CodeMirror.defineMode("lua", function (config, parserConfig) {
    ...
    var builtins = wordRE([
      ...
      "loadfile", "loadstring", "module", "next", "pairs", "pcall", "print",
      ...
      "debug.getlocal", "debug.getmetatable",
      "debug.getregistry", "debug.getupvalue", "debug.setfenv", "debug.sethook",
      "debug.setlocal", "debug.setmetatable",
      ...
      "math.ceil", "math.cos", "math.cosh", "math.deg",
      ...
      "os.getenv", "os.remove", "os.rename", "os.setlocale",
      "os.time", "os.tmpname",
    ...
    function normal(stream, state) {
      ...
      if (ch == "-" && stream.eat("-")) {
        if (stream.eat("[") && stream.eat("[")) {
          return (state.cur = bracketed(readBracket(stream), "comment"))(stream,
              state);
        }
        stream.skipToEnd();
        return "comment";
      ...
      if (ch == "[" && /[\[=]/.test(stream.peek())) {
        return (state.cur = bracketed(readBracket(stream), "string"))(stream,
            state);
      }
      if (/\d/.test(ch)) {
        stream.eatWhile(/[\w.%]/);

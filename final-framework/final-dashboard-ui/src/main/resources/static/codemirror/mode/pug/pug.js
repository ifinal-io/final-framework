...
(function (mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
  {
    mod(require("../../lib/codemirror"), require("../javascript/javascript"),
        require("../css/css"), require("../htmlmixed/htmlmixed"));
  } else if (typeof define == "function" && define.amd) // AMD
  {
    define(["../../lib/codemirror", "../javascript/javascript", "../css/css",
  ...
  CodeMirror.defineMode("pug", function (config) {
    ...
    function includeFiltered(stream, state) {
      if (stream.match(/^include:([a-zA-Z0-9\-]+)/, false) && stream.match(
          'include')) {
    ...
    function attrsContinued(stream, state) {
      if (state.isAttrs) {
        ...
        if (state.attrsNest.length === 0 && (tok === 'string' || tok
            === 'variable' || tok === 'keyword')) {
          try {
            Function('',

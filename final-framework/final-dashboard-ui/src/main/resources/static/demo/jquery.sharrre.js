  ...
  var pluginName = 'sharrre',
      ...
      loadButton = {
        ...
        facebook: function (self) {
          ...
          $(self.element).find('.buttons').append(
              ...
              + '" data-send="' + sett.send + '" data-layout="' + sett.layout
              + '" data-width="' + sett.width + '" data-show-faces="'
              + sett.faces + '" data-action="' + sett.action
              + '" data-colorscheme="' + sett.colorscheme + '" data-font="'
              + sett.font + '" data-via="' + sett.via + '"></div></div>');
          var loading = 0;
          if (typeof FB === 'undefined' && loading == 0) {
            ...
            (function (d, s, id) {
              ...
              js.id = id;
              js.src = '//connect.facebook.net/' + sett.lang
                  + '/all.js#xfbml=1';
        ...
        twitter: function (self) {
          ...
          $(self.element).find('.buttons').append(
              ...
              + (sett.url !== '' ? sett.url : self.options.url)
              + '" data-count="' + sett.count + '" data-text="'
              + self.options.text + '" data-via="' + sett.via
              + '" data-hashtags="' + sett.hashtags + '" data-related="'
              + sett.related + '" data-lang="' + sett.lang
              + '">Tweet</a></div>');
          var loading = 0;
        ...
        digg: function (self) {
          ...
          $(self.element).find('.buttons').append(
              '<div class="button digg"><a class="DiggThisButton ' + sett.type
        ...
        stumbleupon: function (self) {
          ...
          $(self.element).find('.buttons').append(
              '<div class="button stumbleupon"><su:badge layout="' + sett.layout
        ...
        linkedin: function (self) {
          ...
          $(self.element).find('.buttons').append(
              ...
              + (sett.url !== '' ? sett.url : self.options.url)
              + '" data-counter="' + sett.counter + '"></script></div>');
          var loading = 0;
      ...
      popup = {
        googlePlus: function (opt) {
          window.open(
              "https://plus.google.com/share?hl=" + opt.buttons.googlePlus.lang
        ...
        twitter: function (opt) {
          window.open(
              ...
              opt.text) + "&url=" + encodeURIComponent(
        ...
        digg: function (opt) {
          window.open(
              "http://digg.com/tools/diggthis/submit?url=" + encodeURIComponent(
        ...
        stumbleupon: function (opt) {
          window.open(
              'http://www.stumbleupon.com/badge/?url=' + encodeURIComponent(
        ...
        linkedin: function (opt) {
          window.open(
              'https://www.linkedin.com/cws/share?url=' + encodeURIComponent(

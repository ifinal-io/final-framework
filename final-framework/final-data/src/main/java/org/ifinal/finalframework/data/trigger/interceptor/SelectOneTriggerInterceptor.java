...
import org.ifinal.finalframework.data.trigger.SelectTrigger;
import org.ifinal.finalframework.data.trigger.TriggerManager;
 ...
 * @author likly
 * @version 1.0.0
 * @see Repository#selectOne(String, Class, Serializable, IQuery)
 * @since 1.0.0
 */

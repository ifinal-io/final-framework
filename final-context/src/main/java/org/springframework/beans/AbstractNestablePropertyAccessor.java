...
public abstract class AbstractNestablePropertyAccessor extends AbstractPropertyAccessor {
    ...
    private java.util.List<org.ifinalframework.beans.BeanTypeDescriptorFactory> beanTypeDescriptorFactories = org.springframework.core.io.support.SpringFactoriesLoader.loadFactories(org.ifinalframework.beans.BeanTypeDescriptorFactory.class, getClass().getClassLoader());
    ...
    private Object create(Class<?> type,org.springframework.core.convert.TypeDescriptor desc){
    ...
    private Object newValue(Class<?> type, @Nullable TypeDescriptor desc, String name) {
        ...
        for (final BeanTypeDescriptorFactory beanTypeDescriptorFactory : beanTypeDescriptorFactories) {
            if (beanTypeDescriptorFactory.support(desc)) {
                return beanTypeDescriptorFactory.create(type, desc);
            }
        }

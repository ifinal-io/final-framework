...
Final is base on `spring` and integrated `mybats`, `shardingshpere`.

## Modules

|                          Dependency                          |       Description        |                           Version                            |
| :----------------------------------------------------------: | :----------------------: | :----------------------------------------------------------: |
|       final-annotation      |     Define annotation and interface     | |
|       final-framework      |    Core function       | |
|       final-auto      |    Auto generate source code      | |
|       final-boot      |    Final boot starter      | |

...
(function ($) {
  $.fn.toc = function (options) {
    ...
    function createLink(indexs, header) {
      ...
      $('#' + header.id).text(indexs.join('.') + '. ' + innerText);
      return `<a class='nav-link' href='#${header.id}'>${indexs.join(
          '.')}. ${innerText}</a>`;
    }

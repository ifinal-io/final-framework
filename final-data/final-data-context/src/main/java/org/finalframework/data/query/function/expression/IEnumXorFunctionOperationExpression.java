 ...
 */
@FunctionExpression(
        value = FunctionExpression.XOR,
        types = {IEnum.class}
)
public class IEnumXorFunctionOperationExpression<T extends IEnum> implements FunctionOperationExpression<SingleFunctionOperation<T>> {
    @Override

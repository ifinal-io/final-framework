 ...
 * @since 1.0
 */
public class DateBetweenCriterionOperation extends AbsCriterionOperation<Date> implements com.ilikly.finalframework.data.query.BetweenCriterionOperation<Date> {

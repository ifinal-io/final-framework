 ...
 * @since 1.0
 */
public class GreaterThanCriterionOperation<T> extends AbsCriterionOperation<T> implements SingleCriterionOperation<T> {
    ...
    public CriterionOperator operator() {
        return CriterionOperators.GREATER_THAN;
    }

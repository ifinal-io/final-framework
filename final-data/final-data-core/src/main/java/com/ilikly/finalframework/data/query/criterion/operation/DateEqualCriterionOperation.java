 ...
 * @since 1.0
 */
public class DateEqualCriterionOperation extends AbsCriterionOperation<Date> implements SingleCriterionOperation<Date> {

    public static final DateEqualCriterionOperation INSTANCE = new DateEqualCriterionOperation();

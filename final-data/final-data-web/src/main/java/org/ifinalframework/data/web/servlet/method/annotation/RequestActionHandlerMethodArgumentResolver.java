 ...
 **/
@Component
public class RequestActionHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    @Resource
    private DomainActionRegistry domainActionRegistry;

    @Override
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.hasParameterAnnotation(RequestAction.class);
    }

...
public class CriteriaSet implements Criteriable<Criteria> {
    ...
    CriteriaSet(Criteria criteria, Property property, AndOr andOr) {
        this.criteria = criteria;
        this.property = property;
        this.andOr = andOr;
    }

    public static CriteriaSet where(Property property, AndOr andOr) {
        return new CriteriaSet(null, property, andOr);
    }

    public static CriteriaSet where(Property property) {

...
import cn.com.likly.finalframework.spring.handler.exception.annotation.RestExceptionHandler;
    ...
    public void init() {
        this.exceptionHandlerBeans = BeanUtils.findAllBeansAnnotatedBy(applicationContext, RestExceptionHandler.class)
                .map(it -> {
                    ...
                    if (!(it instanceof cn.com.likly.finalframework.spring.handler.exception.ExceptionHandler)) {
                    ...
                    return new ExceptionHandlerBean(order == null ? 0 : order.value(), (cn.com.likly.finalframework.spring.handler.exception.ExceptionHandler<Throwable, Object>) it);
                })
                .sorted()

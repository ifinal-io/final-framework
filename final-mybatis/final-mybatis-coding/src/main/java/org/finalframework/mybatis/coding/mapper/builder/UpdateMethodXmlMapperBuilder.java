 ...
 * @since 1.0
 */
public class UpdateMethodXmlMapperBuilder extends AbsXmlMapperBuilder implements MethodXmlMapperBuilder {
    ...
    @Override
    public Collection<Element> sqlFragments(ExecutableElement method, Document document, Entity<Property> entity) {

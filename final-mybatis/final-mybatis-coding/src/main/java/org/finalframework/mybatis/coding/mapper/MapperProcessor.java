...
//                            document = documentBuilder.parse(existingFile.openInputStream());
                    ...
                    for (TypeMirror item : interfaces) {
                        ...
                        builder.append("absMapper=").append(absMapperType.toString()).append("\n");
                        builder.append("interface=").append(item.toString()).append("\n");
                        builder.append("isAssignable=").append(types.isAssignable(types.erasure(item), types.erasure(absMapperType))).append("\n");
                        builder.append("isSubtype=").append(types.isSubtype(types.erasure(item), types.erasure(absMapperType))).append("\n");
                        builder.append("isSameType=").append(types.isSameType(types.erasure(item), types.erasure(absMapperType))).append("\n");

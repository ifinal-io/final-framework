...
public class XMLScriptBuilder extends BaseBuilder {
  ...
  private void initNodeHandlerMap() {
    nodeHandlerMap.put("trim", new TrimHandler(this));
    nodeHandlerMap.put("where", new WhereHandler(this));
    nodeHandlerMap.put("set", new SetHandler(this));
    ...
    nodeHandlerMap.put("bind", new BindHandler(this));
  }
  ...
  public Map<String, NodeHandler> getNodeHandlerMap() {

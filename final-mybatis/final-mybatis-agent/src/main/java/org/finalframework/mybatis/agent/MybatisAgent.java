...
public final class MybatisAgent {
    ...
    public synchronized void agent() {
        ...
        try {
             ...
             *          org.finalframework.datasource.agent.XMLMapperBuilderAgent.configurationDefaultElement(parser.evalNode("/mapper"));
             *     }
             *     parse$agent();
             * }
             */
            ...
            body.append("if (!configuration.isResourceLoaded(resource)) {")
                    .append("org.finalframework.mybatis.agent.XMLMapperBuilderAgent.configurationDefaultElement(parser.evalNode(\"/mapper\"));")
                    .append("}");
